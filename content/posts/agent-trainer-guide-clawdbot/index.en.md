...
I mentioned in a previous blog post about wrapping Apple's built-in Apple Intelligence 3B model into an OpenAI-compatible API. I had Clawdbot run some tests to find its boundaries—reasoning ability, code completion, translation quality. After testing, I thought the information was valuable, so on a whim, I asked it to write it up as a blog post. The result was surprisingly good.
...
OK, that's it for this one. See you next time—go adopt your own Clawdbot!
